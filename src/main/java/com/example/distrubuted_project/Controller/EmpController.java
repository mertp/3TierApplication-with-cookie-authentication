...
import com.example.distrubuted_project.Repository.*;
...
public class EmpController {
        ...
        public EmpController(EmpRepository empRepository,DeptRepository departmentRepository,BonusRepository bonusRepository,SalgradeRepository salgradeRepository,EmpService service) {
    ...
    public String home(Emp emp, Model model, String keyword) {
        if(keyword!=null) {
            List<Emp> list = service.findByKeyword(keyword);
